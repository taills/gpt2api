...
type Account struct {
	...
	TokenExpiresAt   sqltime.NullTime `db:"token_expires_at" json:"token_expires_at,omitempty"`
	...
	WarnedAt         sqltime.NullTime `db:"warned_at" json:"warned_at,omitempty"`
	CooldownUntil    sqltime.NullTime `db:"cooldown_until" json:"cooldown_until,omitempty"`
	LastUsedAt       sqltime.NullTime `db:"last_used_at" json:"last_used_at,omitempty"`
	TodayUsedCount   int              `db:"today_used_count" json:"today_used_count"`
	TodayUsedDate    sqltime.NullTime `db:"today_used_date" json:"today_used_date,omitempty"`

	LastRefreshAt     sqltime.NullTime `db:"last_refresh_at" json:"last_refresh_at,omitempty"`
	...
	ImageQuotaResetAt   sqltime.NullTime `db:"image_quota_reset_at"   json:"image_quota_reset_at,omitempty"`
	ImageQuotaUpdatedAt sqltime.NullTime `db:"image_quota_updated_at" json:"image_quota_updated_at,omitempty"`

	Notes     string           `db:"notes" json:"notes"`
	CreatedAt time.Time        `db:"created_at" json:"created_at"`
	UpdatedAt time.Time        `db:"updated_at" json:"updated_at"`
	DeletedAt sqltime.NullTime `db:"deleted_at" json:"-"`
